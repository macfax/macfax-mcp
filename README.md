...
| `lookup_mac_serial` | Serial to model for any Mac: pre-2021 serials from Apple's config-code data, 2021+ randomized serials from Apple's own device database. Also cross-references verified Macfax reports. |
